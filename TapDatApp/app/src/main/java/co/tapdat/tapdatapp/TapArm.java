...
public class TapArm extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tap_arm);
        setupActionBar();
        ...
        //figure out if this came in from NFC tag OR from Armed area

        String action = i.getAction();
        if (NfcAdapter.ACTION_NDEF_DISCOVERED.equals(action)) {
            strTipMessage = "Ready to Tip ";
            ...
            strTipMessage = "You Just TIPPED " + strTagID + " $"+ strTipMessage + "!";
        }
  ...
  //      mSystemUiHider.setup();
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        txtAfterTap.setText(strTipMessage);
...
//            mSystemUiHider.hide();
    ...
    private class NdefReaderTask extends AsyncTask<Tag, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if (result != null) {
                TextView txtAfterTap = (TextView) findViewById(R.id.txtAfterTap);
                txtAfterTap.setText("Ready to Tip: " + result);
                Button btnTapDat = (Button) findViewById(R.id.btnTapDat);
                btnTapDat.setText("SEND");
                //put in code to change teh mode to send vs. tap -> no going to armed!!!
            }
        }
    }
