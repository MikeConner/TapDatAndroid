...
public void loadit(View view){
    ...
    public void startWrite (View view){
        ...
        mNfcAdapter = NfcAdapter.getDefaultAdapter(AccountActivity.this);
        mNfcPendingIntent = PendingIntent.getActivity(AccountActivity.this, 0,
                new Intent(AccountActivity.this, AccountActivity.class).addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP), 0);

        enableTagWriteMode();

        new AlertDialog.Builder(AccountActivity.this).setTitle("Touch tag to write")
